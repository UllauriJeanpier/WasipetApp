...
class DestacadoComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    /* console.log('Actived canjes en producto destacado es', activedCanjes); */
    ...
    return (
      <View style={styles.ProductContainer}>
        ...
        <View style={styles.buttonProductContainer}>
          {points > product.pointsTrade && activedCanjes ? (
            <TouchableOpacity
              style={styles.canjeButton}
              onPress={() => {
            ...
            <TouchableOpacity
              ...
              <Text style={styles.textUnableButton}>
                Canjear por {product.pointsTrade} puntos
              </Text>
            </TouchableOpacity>
          )}
